shared.LoaderTitle = "جارٍ تحميل سكربت المطور ترانكس";
...
game.StarterGui:SetCore("SendNotification", {
    ...
    Text = "يوزري تيك @tru_nks1"; -- ARAB TEAM
    Duration = 5;
})
...
MakeWindow({
Hub = {
Title = "TRUNKS HUB || V0.3 || Brookhaven RB",
Animation = "سكربت TRUNKS HUB"
},
Key = {
KeySystem = false,
Title = "Key System",
...
AddButton(Main, {
  Name = "انسخ رابط قناة صديقي ترولكس", 
  Callback = function()
    setclipboard('https://youtube.com/@troll.x40_40?si=jWIBPiTaKsXpy1aa')
  end
})
